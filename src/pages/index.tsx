      ...
      <div className="flex w-full max-w-screen-xl flex-col  gap-8 p-8 md:gap-24">
        ...
        >
          ...
          <p>
            ...
            fotovoltaice durabile și în execuția instalațiilor electrice conform
            proiectelor KNX.
          </p>
          <p>
        ...
        >
          ...
          <p>
            Printre serviciile noastre pentru instalatii electrice rezidentiale
            si industriale se numara:
          </p>
        ...
        >
          ...
          <p>Printre serviciile noastre pentru prizele de pamant se numara:</p>
          <ul className="flex list-disc flex-col gap-2 pl-6">
            <li>Proiectare și execuție de prize de pamant naturale</li>
            <li>Proiectare și execuție de prize de pamant artificiale</li>
            <li>Verificare a rezistenței de dispersie a prizelor de pamant</li>
        ...
        >
          <p>
            ...
            punând la dispoziția clienților noștri expertiză și calitate înalte.
          </p>
        ...
        >
          ...
          <p>In colaborare se pot face si proiectarea pentru instalatia KNX</p>
        </Section>
        <div
          id="contact"
